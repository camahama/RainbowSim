...
COLOR_GLASS = (20, 20, 60)       # Samma fyllning som dropparna
COLOR_OUTLINE = (20, 20, 60)  # Samma kantfärg som dropparna
...
class WaveRenderer:
    ...
    def render(self, surface):
        ...
        # Beräkna start- och slutpunkter för linjen x = ky + m
        y_start, y_end = 0, h
...
def main(screen=None):
    ...
    pygame.display.set_caption("Ljusvåg och brytning")
